...
export { WeightedVoteOption, MsgSubmitProposal, QueryProposalsResponse, QueryVoteResponse, QueryDepositRequest, QueryTallyResultRequest, MsgVoteResponse, MsgDeposit, QueryProposalResponse, QueryTallyResultResponse, TextProposal, MsgVoteWeighted, QueryVoteRequest, QueryParamsRequest, QueryParamsResponse, Vote, TallyParams, QueryProposalRequest, Proposal, MsgSubmitProposalResponse, QueryDepositResponse, GenesisState, TallyResult, DepositParams, QueryVotesRequest, QueryVotesResponse, QueryDepositsResponse, QueryDepositsRequest, QueryProposalsRequest, Deposit, VotingParams, MsgVote, MsgVoteWeightedResponse, MsgDepositResponse };
